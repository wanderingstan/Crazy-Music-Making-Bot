...
async def generate_video(image_source: str = None, audio_source: str = None) -> str:
    ...
    if audio_source and (audio_source.startswith('http://') or audio_source.startswith('https://')):
  ...
  # Construct the ffmpeg command with fixed 8 seconds duration
    ...
    # Optionally delete the image and audio files, keeping the video
